...
youporn_re = (r'(?:youporn.*?(?:v=|/v/)|youpo\.rn/|yooouuupooorn.*?id=)'
              '([-_a-zA-Z0-9]+)', re.I)

base_url = 'http://gdata.youporn.com/feeds/api/'
api_url = base_url + 'videos/{}?v=2&alt=jsonc'
search_api_url = base_url + 'videos?v=2&alt=jsonc&max-results=1'
video_url = "http://youpo.rn/%s"
...
@hook.regex(*youporn_re)
def youporn_url(match):
...
@hook.command
def youporn(inp):
    "youporn <query> -- Returns the first YouPorn search result for <query>."
